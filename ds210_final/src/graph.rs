...
//function to read in lines from the cali road network txt file
...
//function to create the graph from the file
pub fn read_graph_from_file(file_path: &str) -> Graph<i32, ()> {
    let mut graph: HashMap<i32, Vec<i32>> = HashMap::new();
    println!("California Network Data");
...
mod tests {
    ...
    fn test_calculate_degree_centrality() {
        let graph = read_graph_from_file("roadNet-CA.txt");
